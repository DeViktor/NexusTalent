...
create policy "Admins manage blog posts"
  on blog_posts for all using (auth.uid() in (select id from users where role = 'admin'))
  with check (auth.uid() in (select id from users where role = 'admin'));
 
insert into blog_posts (id, title, category, date, author, author_avatar_url, image_url, excerpt, content_html)
values
(
  'lideranca-remota-desafios-e-solucoes',
  'Liderança Remota: Desafios e Soluções para um Novo Mundo',
  'Gestão e Liderança',
  '2024-07-28',
  'Ana Silva',
  'https://i.pravatar.cc/100?img=5',
  'https://images.unsplash.com/photo-1542626991-cbc4e32524cc?w=1600&h=900&fit=crop',
  'Gerir equipas à distância tornou-se a norma. Explore connosco os principais desafios da liderança remota e descubra estratégias eficazes para manter a sua equipa motivada e produtiva.',
  $html$<p>A transição para o trabalho remoto trouxe consigo uma série de desafios para os líderes de equipa. A comunicação, a cultura da empresa e a monitorização do desempenho precisam de ser repensadas.</p>
...
(
  ...
  'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1600&h=900&fit=crop',
  'A Inteligência Artificial está a revolucionar a forma como as empresas encontram talentos. Desde a triagem de currículos à análise preditiva, a IA promete um recrutamento mais rápido e justo.',
  $html$<p>A Inteligência Artificial (IA) já não é uma promessa distante, mas sim uma realidade presente em muitos departamentos de Recursos Humanos. As suas aplicações no recrutamento são vastas e transformadoras.</p>
...
<p>Apesar dos benefícios, é crucial garantir que os algoritmos sejam justos e não perpetuem preconceitos existentes. A supervisão humana continua a ser fundamental para um processo de recrutamento ético e eficaz.</p>$html$
),
(
  '5-soft-skills-essenciais-para-2025',
  '5 Soft Skills Essenciais para o Mercado de Trabalho em 2025',
  'Desenvolvimento Pessoal',
  '2024-07-22',
  'Beatriz Costa',
  'https://i.pravatar.cc/100?img=32',
  'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1600&h=900&fit=crop',
  'As competências técnicas são importantes, mas as soft skills são o que o diferencia. Descubra quais as 5 competências comportamentais mais valorizadas pelos empregadores.',
  $html$<p>Num mundo cada vez mais automatizado, as competências humanas, ou soft skills, tornam-se o grande diferencial competitivo para qualquer profissional. Estas são as 5 que você deve priorizar:</p>
<ol>
...
(
  'guia-completo-para-uma-entrevista-de-emprego-de-sucesso',
  'Guia Completo para uma Entrevista de Emprego de Sucesso',
  'Carreira',
  '2024-07-18',
  'Diogo Ferreira',
  ...
  'Uma entrevista de emprego pode ser intimidante, mas a preparação é a chave para o sucesso. Siga o nosso guia passo a passo para se destacar e conquistar a vaga dos seus sonhos.',
  $html$<p>A entrevista é a sua oportunidade de brilhar. Siga estes passos para garantir que está preparado.</p>
